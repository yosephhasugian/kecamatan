...
<head>
    ...
    <style>
        ...
        /* CSS untuk gambar logo (jaya_raya.png) */
        .profile-icon {
        ...
        @media (max-width: 767px) { /* Untuk ukuran layar di bawah 768px (ukuran 'md' Tailwind) */
            .login-container {
                /* Di mobile, container login mengambil lebar penuh dan tidak ada bayangan samping */
                width: 95%; /* Menggunakan 95% agar ada sedikit margin di sisi */
                max-width: 400px; /* Batasi lebar agar tidak terlalu lebar di tablet kecil */
                border-radius: 1.5rem; /* Pastikan pembulatan tetap ada */
                box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.08); /* Shadow yang lebih lembut */
            }

            .left-box {
                padding: 2rem; /* Mengurangi padding untuk mobile (32px) */
            }
            ...
            .app-subtitle {
                font-size: 0.9rem; /* Ukuran subjudul lebih kecil */
            }

            h4 {
                font-size: 1.5rem; /* Ukuran heading login lebih kecil */
            }

            p {
                font-size: 0.875rem; /* Ukuran paragraf deskripsi lebih kecil */
            }

            /* Memastikan form tidak terlalu lebar di mobile */
            .left-box form {
                max-width: 100%; /* Ambil lebar penuh dari left-box */
            }
        }
    </style>
</head>
...
<div class="login-container flex flex-col md:flex-row w-full max-w-6xl mx-auto rounded-3xl shadow-2xl overflow-hidden">
    <div class="left-box w-full md:w-1/2 bg-white p-8 md:p-12 flex flex-col justify-center items-center relative z-10 animate-fade-in-up">
        <div class="login-logo text-6xl text-purple-600 mb-4 animate-bounce-slow">
            <img src="assets/img/jaya_raya.png" alt="User Profile" class="profile-icon w-24 h-24 object-contain">
        </div>
